...
- The configuration of the `Vagrantfile` is extremely long because you not only have to specify which OS you need inside your virtual machine, but the steps required to configure that OS in order to have a development environment,
...
- I'll not use OS **only** images. (So no ubuntu image).
